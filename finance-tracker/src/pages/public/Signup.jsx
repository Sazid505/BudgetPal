...
const s = {
  ...
  hint: { fontSize: '0.74rem', color: '#4a4740' },
  btn: {
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.card}>
        ...
        <p style={s.sub}>Start tracking your finances for free</p>
        <form style={s.form} onSubmit={handleSubmit}>
          ...
          <div style={s.field}>
            <label style={s.label}>Admin Code <span style={{ color: '#5e5b54', fontWeight: 400 }}>(optional)</span></label>
            <input style={s.input} type="password" placeholder="Leave blank for regular account"
              value={adminPassword} onChange={(e) => setAdminPassword(e.target.value)} />
            <span style={s.hint}>Enter "ADMINAUTH" to create an admin account</span>
          </div>
